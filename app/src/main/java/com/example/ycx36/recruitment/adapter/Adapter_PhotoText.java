...
public class Adapter_PhotoText extends RecyclerView.Adapter<Adapter_PhotoText.ViewHolder>{
    private ArrayList<SchoolSceneryText> mData;   //数据
    ...
    public Adapter_PhotoText(ArrayList<SchoolSceneryText> data) {
        this.mData = data;
    }

    public void updateData(ArrayList<SchoolSceneryText> data) {
        this.mData = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.schooltext_item, parent, false);
        // 实例化viewholder
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        // 绑定数据
        SchoolSceneryText schoolSceneryText = mData.get(position); //通过数组分别创建每个数组元素的实例。
        holder.nameText.setText(schoolSceneryText.getName());
        holder.draweeView.setController(schoolSceneryText.getController());
