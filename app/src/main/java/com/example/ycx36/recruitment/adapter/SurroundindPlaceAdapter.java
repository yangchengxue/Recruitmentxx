...
public class SurroundindPlaceAdapter extends RecyclerView.Adapter<SurroundindPlaceAdapter.ViewHolder> {
     ...
     */
    public SurroundindPlaceAdapter(ArrayList<SurroundingPlaceData> data) {
        this.mData = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.surrounding_item, parent, false);
        // 实例化viewholder
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.text1.setText(surroundingPlaceData.getName());
        holder.text2.setText(surroundingPlaceData.getDistance());
        holder.draw_surrounding.setController(surroundingPlaceData.getController());
        /**子项的监听事件*/
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        SimpleDraweeView draw_surrounding;
        ...
        public ViewHolder(View itemView) {
            ...
            draw_surrounding = itemView.findViewById(R.id.draw_surrounding);
        }
    }
